...
<template>
  <SectionShell id="badges" title="Badges" :code="code">
    <template #description>
      Small inline tag/badge for status or category. Five tones cover most
      needs. Always use the primitive — never reach for ad-hoc pill markup.
    </template>
    <template #whenToUse>
      <ul>
    ...
    <template #options>
      <ul class="list-disc pl-5">
        <li>
          <code>tone</code>: <code>neutral</code> (default) |
          <code>accent</code> | <code>signal</code> | <code>muted</code> |
          <code>solid</code>
        </li>
