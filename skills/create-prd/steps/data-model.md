...
Now that features and integrations are locked, propose the data model. Models and their fields should be in English, even if the user inputs are in French.
...
After receiving user input, verify if the user wants to make more adjustments before moving on to the next phase.
