...
- Mention that when they later want to add features beyond this plan, the `update-prd` skill extends this PRD and appends new milestones without re-running the whole interview.
...
### What use cases the app helps users with

{Bulleted list of use cases the users deal with. 5–8 bullets.}
